module datm_datamode_mep13_mod
  ...
  public  :: datm_datamode_mep13_advertise
  public  :: datm_datamode_mep13_init_pointers
  public  :: datm_datamode_mep13_advance
  public  :: datm_datamode_mep13_restart_write
  public  :: datm_datamode_mep13_restart_read
...
!===============================================================================
  ...
  subroutine datm_datamode_mep13_advertise(exportState, fldsexport, flds_scalar_name, rc)
  ...
  end subroutine datm_datamode_mep13_advertise

  !===============================================================================
  subroutine datm_datamode_mep13_init_pointers(exportState, sdat, rc)
    ...
    if (.not. associated(strm_prec) .or. .not. associated(strm_swdn)) then
       call shr_sys_abort(trim(subname)//'ERROR: prec and swdn must be in stream for MEP13')
    endif

    if (.not. associated(strm_tarcf)) then
       call shr_sys_abort(trim(subname)//'ERROR: tarcf must be in an input stream for MEP13')
    endif

  end subroutine datm_datamode_mep13_init_pointers

  !===============================================================================
  subroutine datm_datamode_mep13_advance(exportstate, target_ymd, target_tod, model_calendar, rc)
    ...
    character(len=*), parameter :: subname='(datm_datamode_mep13): '
    !-------------------------------------------------------------------------------
  ...
  end subroutine datm_datamode_mep13_advance

  !===============================================================================
  subroutine datm_datamode_mep13_restart_write(case_name, inst_suffix, ymd, tod, &
  ...
  end subroutine datm_datamode_mep13_restart_write

  !===============================================================================
  subroutine datm_datamode_mep13_restart_read(rest_filem, inst_suffix, logunit, my_task, mpicom, sdat)
  ...
  end subroutine datm_datamode_mep13_restart_read

end module datm_datamode_mep13_mod
